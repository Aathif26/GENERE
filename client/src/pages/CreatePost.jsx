  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Create Imaginative and Visually stunning Image through by AI and share them with the Community</p>
      </div>
        ...
        <div className='flex flex-col gap-5'>
          ...
          {form.photo ? (
            ...
            <img 
              src={preview}
              alt="preview"
              className='w-9/12 h-9/12 object-conatin opacity-40'
            />
          )}
